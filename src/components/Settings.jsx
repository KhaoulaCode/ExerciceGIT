                    ...
                    <div className="row">
                        ...
                        <input 
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    setNbScores(parseInt(e.target.value))
                                }
                            } 
                        />
                    </div>
                    <div className="row">
                        ...
                        <input 
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    setNbChars(parseInt(e.target.value))
                                }
                            }
                        />
                    </div>
                    <div className="row">
                        ...
                        <input
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    setNbTries(parseInt(e.target.value))
                                }
                            }
                            />
                    </div>
