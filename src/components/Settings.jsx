...
import { setNbTries, setNbScores, setNbChars } from "../assets/store/redux-slices/setting";
const Settings = ()=>{
                    ...
                    <div className="row">
                        ...
                        <input 
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    dispatch(setNbScores(parseInt(e.target.value)))
                                }
                            } 
                        />
                    </div>
                    <div className="row">
                        ...
                        <input 
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    dispatch(setNbChars(parseInt(e.target.value)))
                                }
                            }
                        />
                    </div>
                    <div className="row">
                        ...
                        <input
                            ...
                            onChange={
                                e=>{
                                    e.preventDefault();
                                    dispatch(setNbTries(parseInt(e.target.value)))
                                }
                            }
                            />
                    </div>
